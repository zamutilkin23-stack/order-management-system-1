        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {shipmentType === 'order' 
                ? 'Отправленная заявка будет удалена, заявка вернется в статус "Исполнена". Годные материалы автоматически вернутся на склад.'
                : 'Свободная отправка будет удалена. Годные материалы автоматически вернутся на склад.'
              }
              <br /><br />
